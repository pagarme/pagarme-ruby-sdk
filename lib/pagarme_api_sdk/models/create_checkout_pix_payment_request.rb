...
module PagarmeApiSdk
  ...
  class CreateCheckoutPixPaymentRequest < BaseModel
    ...
    def initialize(expires_at = SKIP, expires_in = SKIP,
    ...
    def to_s
      ...
      "<#{class_name} expires_at: #{@expires_at}, expires_in: #{@expires_in},"\
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} expires_at: #{@expires_at.inspect}, expires_in: #{@expires_in.inspect},"\
      " additional_information: #{@additional_information.inspect}>"
    end
  end
end
