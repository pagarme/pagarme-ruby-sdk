...
module PagarmeApiSdk
  ...
  class CreateUsageRequest < BaseModel
    ...
    def initialize(quantity = nil, description = nil, used_at = nil,
                   code = SKIP, group = SKIP, amount = SKIP)
      @quantity = quantity
    ...
    def to_s
      ...
      "<#{class_name} quantity: #{@quantity}, description: #{@description}, used_at: #{@used_at},"\
    ...
    def inspect
      ...
      " used_at: #{@used_at.inspect}, code: #{@code.inspect}, group: #{@group.inspect}, amount:"\
      " #{@amount.inspect}>"
    end
  end
end
