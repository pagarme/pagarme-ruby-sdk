...
module PagarmeApiSdk
  ...
  class GetPixTransactionResponse < GetTransactionResponse
    ...
    def initialize(qr_code = SKIP, qr_code_url = SKIP, expires_at = SKIP,
                   additional_information = SKIP, end_to_end_id = SKIP,
                   payer = SKIP, pix_provider_tid = SKIP, gateway_id = SKIP,
                   ...
                   transaction_type = 'pix', id = SKIP, gateway_response = SKIP,
