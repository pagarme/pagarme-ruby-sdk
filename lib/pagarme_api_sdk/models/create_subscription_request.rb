...
module PagarmeApiSdk
  ...
  class CreateSubscriptionRequest < BaseModel
    ...
    def initialize(customer = nil, card = nil, code = nil, payment_method = nil,
                   billing_type = nil, statement_descriptor = nil,
                   description = nil, currency = nil, interval = nil,
                   interval_count = nil, pricing_scheme = nil, items = nil,
                   shipping = nil, discounts = nil, metadata = nil,
                   increments = nil, setup = SKIP, plan_id = SKIP,
                   customer_id = SKIP, card_id = SKIP, billing_day = SKIP,
                   installments = SKIP, start_at = SKIP, minimum_price = SKIP,
