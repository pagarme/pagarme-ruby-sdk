...
module PagarmeApiSdk
  ...
  class GetIncrementResponse < BaseModel
    ...
    def initialize(id = SKIP, value = SKIP, increment_type = SKIP,
                   status = SKIP, created_at = SKIP, cycles = SKIP,
                   deleted_at = SKIP, description = SKIP, subscription = SKIP,
    ...
    def to_s
      ...
      "<#{class_name} id: #{@id}, value: #{@value}, increment_type: #{@increment_type}, status:"\
      " #{@status}, created_at: #{@created_at}, cycles: #{@cycles}, deleted_at: #{@deleted_at},"\
      " description: #{@description}, subscription: #{@subscription}, subscription_item:"\
      " #{@subscription_item}>"
    end
    ...
    def inspect
      class_name = self.class.name.split('::').last
      "<#{class_name} id: #{@id.inspect}, value: #{@value.inspect}, increment_type:"\
      " #{@increment_type.inspect}, status: #{@status.inspect}, created_at:"\
      " #{@created_at.inspect}, cycles: #{@cycles.inspect}, deleted_at: #{@deleted_at.inspect},"\
      " description: #{@description.inspect}, subscription: #{@subscription.inspect},"\
      " subscription_item: #{@subscription_item.inspect}>"
    end
  end
end
